		...
		*/
		...
		{			
			...
			public void serialize(Element what, OutputStream destination) {
				...
				try 
				{
					//			xercesc::XMLDOMSerializer.serialize(what, destination);
			...
			*/
			std::string serialize(Element what) 
			{
		...
		void Store::persist(const XML& xml)
		{
			pImpl->persist(xml);
		}    
		...
		//		void Store::serialize(const Element& what, OutputStream destination)
		//		{
